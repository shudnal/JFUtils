...
{
    static public void SmoothLine(this LineRenderer lineRenderer, Vector3[] points, int subDivisions,
...

    {
...

        {
            ...
            {
                tangent = ((points[i + 2] - points[i + 1]).normalized + (points[i + 1] - points[i]).normalized)
                          * -smoothingLength;
            }
